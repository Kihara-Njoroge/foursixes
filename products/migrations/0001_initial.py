# Generated by Django 3.2.8 on 2021-11-15 06:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.PositiveIntegerField(blank=True, choices=[(1, 'delivered'), (2, 'pending'), (3, 'cancelled')], default=2)),
                ('ordered_at', models.DateTimeField(auto_now_add=True)),
                ('shipping_address', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='accounts.address')),
                ('user', models.ForeignKey(null=True, on_delete=models.SET(products.models.get_sentinel_user), related_name='orders', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-ordered_at'],
            },
